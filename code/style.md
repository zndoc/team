...
- [Правила форматирования кода](#format)
- [Использование пробелов](#spaces)
...
## Правила форматирования кода <a name="format"></a>
...
## Использование пробелов <a name="spaces"></a>
...
- Открывающая фигурная скобка `{` в определении класса ДОЛЖНА 
располагаться на новой строке, а закрывающая фигурная скобка 
ДОЛЖНА располагаться на следующей строке после тела класса 
(используется `Allman style braces`)
...
- Фигурные скобки могут опускаться там где они не нужны, например в `if-else-if-else`, `for`, `while`, `do-while` конструкциях
...
* [Стандарт кодирования на PHP в Zend Framework'е](https://framework.zend.com/manual/1.12/ru/coding-standard.coding-style.html)
* [Стиль оформления кода PHP](https://tuning-soft.ru/articles/php/style-code-php.html)
